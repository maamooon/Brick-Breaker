...
int main() {
    ...
    gotoxy(54, 23);
    cout << "By Mamoon Ahmed and Abdul Rafay<3\n";
    for (int g = 5; g < 24; g++)
    {
        gotoxy(27, g);
        cout << "*\n";
    ...
    drawRectangle(185, 80, 1117, 705, 255, 255, 255, 0, 0, 0);
    if (lives == 3)
    {
    ...
    while (final == true && lives > 0) {
        ...
        ball_y1 += j_e;
        ball_y2 += j_e;
        drawRectangle(bat_x1, bat_y1, bat_x2, bat_y2, 123, 123, 123, 123, 123, 123);
        ...
        if (bat_x2 >= 1070)            //Not letting escape (right side)
        {
            i -= 30;
        }
        if (bat_x1 <= 217)             // Not letting escape (left side)
        {
            i += 30;
        }
